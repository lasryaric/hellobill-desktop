...
function getURL(mConnector, credentials) {
  var name2connector = {
    ...
    edf: 'https://particulier.edf.fr/fr/accueil/espace-client/tableau-de-bord.html',
    sfr: 'https://espace-client.sfr.fr/facture-mobile/',
    airbnb: 'https://www.airbnb.com/users/transaction_history',
    adwords: 'http://www.google.com/adwords/',
    mailchimp: 'https://us4.admin.mailchimp.com/account/billing-history/',
  }
